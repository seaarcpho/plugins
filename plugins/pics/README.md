...
| actors.[0].mustMatchInFilename  | boolean                                                          | false    | If the name of the actor and the `searchTerms` must exist in the basename of the file, instead of anywhere in the path                                                 |
...
| scenes.[0].mustMatchInFilename  | boolean                                                          | false    | If the name of the scene and the `searchTerms` must exist in the basename of the file, instead of anywhere in the path                                                 |
...
| actors.[0].mustMatchInFilename  | boolean                                                          | false    | If the name of the movie and the `searchTerms` must exist in the basename of the file, instead of anywhere in the path                                                 |
...
| studios.[0].mustMatchInFilename | boolean                                                          | false    | If the name of the studio and the `searchTerms` must exist in the basename of the file, instead of anywhere in the path                                                |
